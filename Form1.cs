...
namespace Tepra_App
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            sql = "select p.CODE,p.KCODE,h.NAME from TPiCSDB41.dbo.XPRTS p left join TPiCSDB41.dbo.XHEAD h on p.KCODE = h.CODE Where p.CODE = '" + str + "' and h.NAME like '%œ∞∏¡≠∞Ãﬁ%' order by p.KCODE";
